...
sudo dpkg -r $FNAME_LIBSGX_DCAP_DEFAULT_QPL $FNAME_LIBSGX_DCAP_DEFAULT_QPL_DEV $FNAME_LIBSGX_DCAP_DEFAULT_QPL_DBG
sudo dpkg -r $FNAME_LIBSGX_DCAP_QL $FNAME_LIBSGX_DCAP_QL_DEV $FNAME_LIBSGX_DCAP_QL_DBG
sudo dpkg -r $FNAME_LIBSGX_ENCLAVE_COMMON $FNAME_LIBSGX_ENCLAVE_COMMON_DEV $FNAME_LIBSGX_ENCLAVE_COMMON_DBGSYM
