...
SGX_DOWNLOAD_URL_BASE="https://download.01.org/intel-sgx/sgx-dcap/1.3/linux/distro/ubuntuServer16.04"

# download file name
LIBSGX_DCAP_DEFAULT_QPL_DEV=libsgx-dcap-default-qpl-dev_1.3.100.4-xenial1_amd64.deb
LIBSGX_DCAP_DEFAULT_QPL=libsgx-dcap-default-qpl_1.3.100.4-xenial1_amd64.deb
LIBSGX_DCAP_PCCS=libsgx-dcap-pccs_1.3.100.4-xenial1_amd64.deb
LIBSGX_DCAP_QL_DEV=libsgx-dcap-ql-dev_1.3.100.4-xenial1_amd64.deb
LIBSGX_DCAP_QL=libsgx-dcap-ql_1.3.100.4-xenial1_amd64.deb
LIBSGX_ENCLAVE_COMMON_DEV=libsgx-enclave-common-dev_2.7.100.4-xenial1_amd64.deb
LIBSGX_ENCLAVE_COMMON=libsgx-enclave-common_2.7.100.4-xenial1_amd64.deb
